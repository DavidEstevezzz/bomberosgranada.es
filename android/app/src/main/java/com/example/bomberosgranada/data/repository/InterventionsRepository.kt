...
import com.example.bomberosgranada.data.api.services.CreateInterventionRequest
import com.example.bomberosgranada.data.api.services.Intervention
import com.example.bomberosgranada.data.api.services.UpdateInterventionRequest
...
class InterventionsRepository {
    ...
    suspend fun createIntervention(intervention: CreateInterventionRequest): Result<Intervention> {
        return try {
            ...
            Log.d(TAG, "Parte: ${intervention.parte}, Tipo: ${intervention.tipo}")
