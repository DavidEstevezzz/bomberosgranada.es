    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div className={`rounded-2xl border px-4 py-3 text-center ${cardBg}`}>
          ...
          <p className={`mt-1 text-xl font-bold ${vacationDaysAvailable - totalDaysUsed < 6 ? 'text-red-500' : 'text-emerald-500'}`}>
      ...
      <div className={`rounded-2xl border px-4 py-3 text-xs ${darkMode ? 'border-blue-500/20 bg-blue-500/5 text-blue-300' : 'border-blue-200 bg-blue-50 text-blue-700'}`}>
        <p className="font-medium">Cada guardia seleccionada consume 6 días de vacaciones.</p>
 ...
 */
const GuardCard = ({ guard, isSelected, onToggle, disabled, darkMode }) => {
