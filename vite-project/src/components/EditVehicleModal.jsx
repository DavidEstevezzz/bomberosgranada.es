      ...
      <div className={`bg-white dark:bg-gray-800 p-4 w-full max-w-2xl rounded-lg shadow-lg`}>
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid gap-4 mb-4 sm:grid-cols-2">
            ...
            {/* Nombre del Vehículo */}
            <div>
              <label htmlFor="nombre" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre del Vehículo</label>
              <input
                type="text"
                name="nombre"
                id="nombre"
            ...
            {/* Parque: Se muestra un select con los nombres y se asigna el id_parque */}
            <div>
              <label htmlFor="id_parque" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Parque</label>
              <select
                name="id_parque"
                id="id_parque"
