...
const IncidentDetailModal = ({ incident, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full h-full bg-black bg-opacity-50">
      <div
        className={`p-6 w-full max-w-2xl rounded-lg shadow-lg ${modalContentClass} ${
      ...
      >
        ...
        <div className="space-y-3">
          <p>
            ...
            {incident.creator
              ? `${incident.creator.nombre} ${incident.creator.apellido}`
              : incident.id_empleado}
          </p>
          <p>
            <strong>Tipo:</strong>{' '}
          ...
          <p>
            <strong>Fecha:</strong> {dayjs(incident.fecha).format('DD/MM/YYYY')}
          </p>
          <p>
            <strong>Leído:</strong> {incident.leido ? 'Sí' : 'No'}
          </p>
          <p>
          ...
          {incident.tipo === 'vehiculo' && (
            <p>
              <strong>Vehículo:</strong> {incident.vehicle.nombre}
            </p>
          )}
          ...
          <p>
            ...
            {incident.resolver
              ? `${incident.resolver.nombre} ${incident.resolver.apellido}`
              : 'No resuelto'}
          </p>
          <p>
