    ...
    <div className={overlayClass} onMouseDown={handleClose}>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6 px-6 py-6 sm:px-8">
          {submitError && (
            <div
              className={`rounded-2xl border px-4 py-3 text-sm font-medium ${darkMode ? 'border-red-500/40 bg-red-500/10 text-red-200' : 'border-red-200 bg-red-50 text-red-700'
                }`}
            >
              {submitError}
            </div>
