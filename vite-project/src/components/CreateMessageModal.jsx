...
const isMobileDevice = () => {
  return window.innerWidth <= 768; // ejemplo: pantallas <= 768px
};

const CreateMessageModal = ({ isOpen, onClose, currentUserRole }) => {
  ...
  // NUEVO estado para “es móvil/tablet”
  const [isMobile, setIsMobile] = useState(false);

  useEffect(() => {
    if (isOpen) {
      // Determinar si es móvil/tablet
  ...
  // Clase adicional si es móvil => overflow-y-auto
