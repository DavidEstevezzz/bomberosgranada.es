...
Route::post('/firefighters-assignments/{id}/move-to-top', [FirefighterAssignmentController::class, 'moveToTop']);
Route::post('/firefighters-assignments/{id}/move-to-bottom', [FirefighterAssignmentController::class, 'moveToBottom']);
